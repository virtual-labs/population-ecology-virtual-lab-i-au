...
* Test Steps
  ...
  6. Don't click on step run button and click on run iteration button
  7. To known the information about the statistics,dataplots and worksheets click on the respective buttons
